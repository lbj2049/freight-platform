      ...
      <Form ref="editItemForm" :model="demand" :rules="rules" :label-width="120" class="qib-form">
        ...
        <Row>
          ...
          <Col span="22">
            <Row>
              <Col span="16">
                <FormItem label="收货单名称" prop="title">
                  <Input v-model="demand.title" placeholder="请输入收货单名称"/>
                </FormItem>
              </Col>
              <Col span="8">
          ...
          <Col span="22">
            <FormItem>
              <CheckboxGroup>
                ...
                （可根据您的收货，选择录入发到站截取、送达、仓储等物流服务信息）
              </CheckboxGroup>
            </FormItem>
          </Col>
        </Row>
